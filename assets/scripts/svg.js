...
const ICONS = {
  ...
  arrowRight: {
    viewBox: '0 0 24 24',
    content: `<path d="M9 6L15 12L9 18" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>`
  }
};
...
export const toolsIcon = (options) => createIcon('tools', options);
export const cursorIcon = (options) => createIcon('cursor', options);
export const crosshairIcon = (options) => createIcon('crosshair', options);
export const trendlineIcon = (options) => createIcon('trendline', options);
export const penIcon = (options) => createIcon('pen', options);
export const fibIcon = (options) => createIcon('fib', options);
export const measureIcon = (options) => createIcon('measure', options);
export const fitIcon = (options) => createIcon('fit', options);
export const nowIcon = (options) => createIcon('now', options);
export const timeframeIcon = (options) => createIcon('timeframe', options);
export const deleteIcon = (options) => createIcon('delete', options);
export const moveIcon = (options) => createIcon('move', options);
export const arrowRightIcon = (options) => createIcon('arrowRight', options);
