...
export function initEmptyState(container, chart, willLoad) {
  ...
  el.innerHTML = `<div id="chart-empty-text">${willLoad?'<p id="cet-main">Loading…</p>':`<p id="cet-main">CHARTYFI</p><p id="cet-sub">Use the search bar at the top right, or open the sidebar to upload a dataset</p>`}</div><div id="chart-empty-bars">${bars}</div>`;
